---
title: ConvoySIM — Versions (Retired)
type: archive
date: 2026-05-30
description: Retired manual filesystem snapshot log. Replaced by git on 2026-05-30. Historical records preserved below.
tags: [convoysim, archive, versions]
related: ["[[AGENTS]]"]
---

# ConvoySIM Versions — RETIRED 2026-05-30

> **This manual-snapshot scheme has been replaced by git** (`git init` 2026-05-30). See [[AGENTS]] §13.
> Use `git log` for version history going forward.
> Historical snapshot records are preserved below and archived to `archive/versions_retired.md`.

This file previously tracked filesystem version snapshots for ConvoySIM.
